...
const KEYWORD_RULES = [
  ...
  {
    keywords: ["進度", "洗好了嗎", "洗好了", "清洗進度", "什麼時候好", "什麼時候洗好", "還沒好", "好了嗎", "洗完了嗎", "還要等多久", "洗到哪了", "洗到哪裡了", "洗完了", "洗完沒", "洗好了沒", "清洗到哪", "什麼時候可以拿", "什麼時候取", "什麼時候取件", "還沒收到", "還沒送回來", "還沒拿到", "還沒送達", "洗多久", "要多久", "進度如何", "目前進度", "洗多久了", "完成了嗎", "完成了沒", "現在可以拿了嗎", "可以拿了嗎", "可以取了嗎", "幫我查進度", "查詢進度", "洗的怎麼樣", "洗的如何", "洗的進度"],
    response: "營業時間會馬上查詢您的清洗進度😊，並回覆您！或是您可以這邊線上查詢🔍 " + "https://liff.line.me/2004612704-JnzA1qN6"
  },
  {
    keywords: ["營業時間", "幾點開門", "幾點開店", "幾點關門", "幾點營業", "營業到幾點", "營業嗎", "開到幾點", "關門", "什麼時候開", "什麼時候關", "今天有開嗎", "明天有開嗎", "星期天.*營業", "週末.*營業", "假日.*營業", "連假.*開嗎", "什麼時候.*開", "什麼時候.*關", "現在.*營業嗎", "有開嗎", "有開", "休息", "有休息嗎", "有營業", "營業", "開店"],
    response: "今日有營業的💖我們的營業時間為 10:30 - 20:00，除週六固定公休喔！😊"
  },
  // 其他規則保持不變...
  {
    keywords: ["有洗.*汽座", "有洗.*手推車", "有清洗.*汽座", "有清洗.*手推車", "寶寶汽座可以清洗", "寶寶汽座可以洗", "手推車可以清洗", "手推車可以洗", "汽座可以清洗", "汽座可以洗", "兒童安全座椅能洗嗎", "兒童安全座椅能清洗嗎", "安全座椅能清洗嗎", "安全座椅能水洗嗎", "嬰兒推車能洗嗎", "嬰兒推車能清洗嗎", "手推車能洗嗎", "手推車能清洗嗎", "汽座能水洗嗎", "寶寶安全座椅能水洗嗎", "安全座椅能水洗嗎", "這個汽座可以清洗嗎", "這台手推車可以洗嗎", "這台嬰兒推車可以清洗嗎", "寶寶推車能送洗嗎", "嬰兒推車能送洗嗎", "安全座椅能送洗嗎", "兒童安全座椅能送洗嗎"],
