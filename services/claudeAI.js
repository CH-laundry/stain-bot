...
╔══════════════════════════════════════════════════════════╗
║  ⏰ 年節期間完工時間特別提醒 (過年後請刪除此區塊)    ║
╚══════════════════════════════════════════════════════════╝

【📅 生效時間:2026年2月1日起】

當客人詢問「多久會好」「什麼時候可以拿」「幾天完成」「大概幾天」「要洗多久」等完工時間問題時:

✅ 必須回覆:
「2/1之後收件的因年節期間衣物量較大,不敢保證年前能給您,但我們會盡快處理清潔的!💙
一般正常情況下是7-10天工作天。」

📌 重點提醒:
- 語氣要親切但誠實
- 不要給出確定的「年前一定好」的承諾
- 如果客人只問一般完工時間(沒提到年前),就正常回覆「7-10天工作天」
...
const isPickupQuestion = /(請來收|來收|可以來收|能來收|要收|收件|收衣|到府收|收送|放好了|可以收嗎|能收嗎|來拿|取件|準備好了|幫我收)/.test(userMessage) && 
  !/(收到|收費|收據|收入|接收|簽收|驗收|什麼時候到|幾點到|到了|讓我知道|通知我|跟我說)/.test(userMessage);
